...
(lib.HeroGraphic5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-2,-8.5,0.4,0.368);
...
p.nominalBounds = new cjs.Rectangle(-2,-8.5,20,43.5);
...
(lib.HeroGraphic4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-1,-8,0.085,0.083);
...
p.nominalBounds = new cjs.Rectangle(-1,-8,20,43);
...
(lib.HeroGraphic3 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-2.5,-12.5,0.075,0.073);
...
p.nominalBounds = new cjs.Rectangle(-2.5,-12.5,20.5,47.5);
...
(lib.EnemyJava3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.spring();
	this.instance.setTransform(0,0,0.234,0.333);
...
(lib.EnemyJava2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.EnemyCSS1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,0.273,0.357);
...
(lib.initalgameFiles = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(451.1,224.4,1,1,0,0,0,15,15);

	this.instance_1 = new lib.EndItem();
	this.instance_1.setTransform(545.8,279.4,1,1,0,0,0,25,25);

	this.instance_2 = new lib.HeroGraphic5();
	this.instance_2.setTransform(447.2,291.7,1,1,0,0,0,8,13.2);

	this.instance_3 = new lib.HeroGraphic4();
	this.instance_3.setTransform(409,287.2,1,1,0,0,0,9,13.5);

	this.instance_4 = new lib.HeroGraphic3();
	this.instance_4.setTransform(345.6,284.9,1,1,0,0,0,7.8,11.2);

	this.instance_5 = new lib.PlatformGraphic1();
	this.instance_5.setTransform(405,318.5,1,1,0,0,0,100,10);

	this.instance_6 = new lib.HeroGraphic1();
	this.instance_6.setTransform(487.5,291,1,1,0,0,0,17.5,17.5);
